window.PLAY_SCENES = [
  ...
  },
  {
    ...
    choices: [
      ...
      {
        key: 'comfort_children',
        icon: '🤝',
        text: '울고 있는 아이들과 가족들을 안심시킨다',
        companions: [
      ...
      {
        key: 'remember_command',
        icon: '▤',
        text: '모세의 명령과 하나님의 약속을 다시 떠올린다',
        companions: [
